...
from experiments.baselines.timenet import extract_representations_timenet
...
def main_logic(datasets_folder_path: Path,
    ...
    hidden_dims = closest_power_of_2(m=dataset_seq_length, v=compression_level)
    ...
    extract_representations_timenet(dataset_module=dataset_module,
                                    model_params=timenet_model_params,

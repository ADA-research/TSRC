...
def main_logic(representations_folder_path: Path,
    ...
    cluster_and_evaluate_fn = partial(cluster_and_evaluate_representations,
        ...
        if experiment_folder.is_dir():
            ...
            if match:
                ...
                if seeds_to_consider is None or seed_number in seeds_to_consider:
                    ...
                    cluster_and_evaluate_fn(data_files=representations_files_paths,
...
def main():
    ...
    parser.add_argument('--clustering_results_output_folder', type=str,
